...
public class MainActivity  extends AppCompatActivity  implements CvCameraViewListener2, PoseListener {
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        ShowKeypoints1 = new Mat(height, width, CvType.CV_8UC4);
    ...
    public void onCameraViewStopped() {
        ...
        mRgba.release();
        mGray.release();
        ShowKeypoints1.release();
    }

    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        mRgba = inputFrame.rgba();
        OpencvNativeClass.convertGray(mRgba.getNativeObjAddr(), mGray.getNativeObjAddr());
        asuforia.nativeOrb(mGray.getNativeObjAddr(),ShowKeypoints1.getNativeObjAddr());
        return ShowKeypoints1;
    }

    //public void onPose(Mat inputFrame)
  //  {
//do stuff
  //  }
